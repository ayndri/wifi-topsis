            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Plan Data</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Top #1 Plan This Month</p>
                                <h5 style="font-size:16px;" class="font-weight-bolder">
                                    @if ($topOne != null || count($topOne) > 0)
                                        {{$topOne[0]->name}}
                                    @endif
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Most People Use</p>
                                <h5 style="font-size:16px;" class="font-weight-bolder">
                                    @if ($middle)
                                    {{$middle->name}}
                                    @endif
