...
<div class="container-fluid py-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly type="text" name="role" value="{{ old('role', auth()->user()->role) }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <form role="form" method="POST" action={{ route('profile.pass') }} enctype="multipart/form-data">
                    @csrf
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="re_password" value="">
                                </div>
                            </div>
                        </div>
                    </div>
